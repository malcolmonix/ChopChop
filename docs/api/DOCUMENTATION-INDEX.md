...
| **[MENUVERSE-SYNC.md](MENUVERSE-SYNC.md)** | Order sync between MenuVerse & ChopChop | Integrators |
| **[MENUVERSE-INTEGRATION-ANALYSIS.md](MENUVERSE-INTEGRATION-ANALYSIS.md)** | ⚠️ Current MenuVerse integration status & fixes | Developers/Architects |
...
| **[firebase.js](firebase.js)** | Firebase configuration (dual database support) |
...
| **[test-menuverse-sync.js](test-menuverse-sync.js)** | MenuVerse order sync tests |
